...
C {devices/code_shown.sym} 440 -400 0 0 {name=NGSPICE only_toplevel=true 
value="
.temp \{\{ temp \}\}
.param mc_ok = \{\{ sigma \}\}
.option SEED = \{\{ seed \}\}
...
C {vsource.sym} -190 -240 2 0 {name=V4 value=0 savecurrent=true}
C {vsource.sym} -190 20 2 0 {name=V7 value=0 savecurrent=true}
